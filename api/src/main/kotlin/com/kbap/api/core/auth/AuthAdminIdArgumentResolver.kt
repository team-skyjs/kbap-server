...
class AuthAdminIdArgumentResolver : HandlerMethodArgumentResolver {
    override fun supportsParameter(parameter: MethodParameter): Boolean =
        parameter.hasParameterAnnotation(AuthAdminId::class.java) &&
    ...
    override fun resolveArgument(
        ...
        if (role != MemberRole.ADMIN.name) throw BusinessException(ErrorCode.ADMIN_FORBIDDEN)
        return webRequest.getAttribute(JwtAuthenticationFilter.ADMIN_ID_ATTRIBUTE, RequestAttributes.SCOPE_REQUEST) as? Long
