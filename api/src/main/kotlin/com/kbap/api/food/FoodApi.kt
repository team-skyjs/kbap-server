...
interface FoodApi {
    ...
    @Operation(
        ...
        description = """
            ...
            재료는 두 필드로 내려간다 — ingredients 는 음식 재료 전체({code, name(요청 언어), inclusionPercent}, 확률 내림차순)로 회원·비회원 공통이고,
            ...
            recentReviews 는 최신순 최대 5개 리뷰를 리뷰 목록 API(GET /api/reviews)와 동일한 항목 형태(food 는 항상 null)로 동봉한다.
