...
class FeedbackController(
    ...
    override fun getOne(
        ...
        val item = feedbackService.getMyFeedback(memberId = memberId, installationId = installationId, id = id)
        return ResponseEntity.ok(BaseResponse.ok(MyFeedbackItemResponse.from(item)))
    }
