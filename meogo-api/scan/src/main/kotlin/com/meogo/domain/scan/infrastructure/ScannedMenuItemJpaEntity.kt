...
class ScannedMenuItemJpaEntity(
    ...
    @field:Column(name = "raw_menu_name", nullable = false)
    var rawMenuName: String = "",

    @field:Column(name = "bbox_x", nullable = false)
    var bboxX: Double = 0.0,

    @field:Column(name = "bbox_y", nullable = false)
    var bboxY: Double = 0.0,

    @field:Column(name = "bbox_width", nullable = false)
    var bboxWidth: Double = 0.0,

    @field:Column(name = "bbox_height", nullable = false)
    var bboxHeight: Double = 0.0,

    @field:Column(name = "received_order", nullable = false)
    var receivedOrder: Int = 0,

    @field:Column(name = "risk_level", nullable = false)
