...
- **상태**: Superseded in part by [ADR-0014](./0014-relax-persistence-encapsulation.md)(internal 캡슐화 폐기 — 영속의 도메인 모듈 소유·port 폐기는 유지) · [ADR-0016](./0016-module-diet-three-app-modules.md)(도메인별 모듈 구성 폐기 — 앱 모듈 3개 통합)
- **날짜**: 2026-07-13
