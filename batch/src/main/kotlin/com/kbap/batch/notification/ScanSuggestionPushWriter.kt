...
class ScanSuggestionPushWriter(
    ...
    override fun write(chunk: Chunk<out Long>) {
        ...
        val result = notifier.send(PushRequest(NotificationType.SCAN_SUGGESTION, memberIds, ttlSeconds = ttlSeconds))
        ...
        logger.info("스캔 제안 발송 members={} sent={} failed={}", memberIds.size, result.sent, result.failed)
    }
