...
import com.meogo.application.client.member.CompleteOnboardingUseCase
import com.meogo.application.client.member.GetMyProfileUseCase
...
class MemberController(
    ...
    override fun submitOnboarding(
        ...
        completeOnboardingUseCase.complete(request.toInput(memberId))
    ...
    override fun getMyProfile(
        ...
        val result = getMyProfileUseCase.getMyProfile(memberId)
