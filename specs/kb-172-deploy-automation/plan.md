...
jobs.deploy (environment: <env>):
  ...
  3. ecr-login
  4. [image_tag 미지정 시] docker build --platform linux/amd64 + push (태그: 전 환경 github.sha — R2)
